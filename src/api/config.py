...
# ---------------------------------------------------------------------------
# Root path (sub-path mount — e.g. /emr for qam.hbox.ai/emr)
# ---------------------------------------------------------------------------

# Derive root_path from BASE_PATH (e.g. "/emr/" → "/emr") for FastAPI sub-path mounting
ROOT_PATH = os.environ.get("BASE_PATH", "/").rstrip("/")
